export namespace globals {
  ...
  export const email = "eu@henriquekuwai.com.br";
  export const url = "https://www.henriquekuwai.com.br";
  export const googleAnalyticsId = "G-SBC1Q5VYK5"; // e.g. 'UA-999999999-1'
}
