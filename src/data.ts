...
const cvData = {
  ...
  repository: "https://github.com/rikezenho/portfolio",
  developingSince: "2008",
  frontendSince: "2015",
  personal: {
    logo: "logo.png",
  ...
  history: [
    {
      ...
      provider: "Infracommerce - Vila Olímpia, São Paulo",
      description:
    ...
    },
    {
      ...
      provider: "Netshoes - Liberdade, São Paulo",
      description:
    ...
    },
    {
      ...
      provider: "Agevole - Santo Amaro, São Paulo",
      description:
    ...
    },
    {
      ...
      provider: "Jornal Nippak - Liberdade, São Paulo",
      description:
        "Atualizei o portal do Jornal (WordPress), desenvolvi de ferramentas internas para a equipe e também auxiliei a criação de campanhas online.",
      date: "Ago/12 - Mar/13",
    },
    {
      position: "Webdeveloper",
      provider: "Agência Elementare - Vila Carrão, São Paulo",
      description:
        "Estruturei e montei sites utilizando PHP, ASP, CSS, Javascript (framework jQuery). Desenvolvi painéis de controle, sistemas de gerenciamento de conteúdo e interfaces de usuário.",
      date: "Ago/08 - Jun/10",
    },
  ],
  complementary: [
